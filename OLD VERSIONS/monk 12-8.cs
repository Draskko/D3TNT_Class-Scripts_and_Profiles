...
namespace Astronaut.Scripts.Monk
{
    ...
    public class CombatState : Common.CombatState
    {
		...
		*/
        ...
        static int MobScanDistance = 100; // scan radius for regular mobs (maximum 100 or about two screens)
		static int ouputMode = 1;				// 0 = Minimal Output | 1 = Normal Output | 2 = Debug Output
		// TIMERS
		static CWSpellTimer combatThresholdTimer = new CWSpellTimer(30 * 1000, false);	// Return after 10 seconds regardless
		...
		*/
        ...
        public static bool NewCastMonkTargetSpell(string SpellName, D3Object target, out bool castSuccessfully)
        {
        ...
        bool pickTarget()
        {
			...
			// Display how many targets found
        ...
        protected override void DoExecute(D3Player Entity)
        {
            ...
            CWSpellTimer combatThresholdTimer = new CWSpellTimer(30 * 1000, false);
			//
